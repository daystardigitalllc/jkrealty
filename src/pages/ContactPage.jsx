            ...
            <div className="bg-navy-900 text-white rounded-3xl p-6 shadow-xl border border-bahamas-500/30 space-y-3">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="px-4 py-2.5 rounded-xl bg-slate-800 hover:bg-bahamas-500 text-white text-xs font-bold transition-all border border-slate-700 flex items-center gap-2 group shadow-sm"
                >
